...
const HOTSPOTS: HotspotPosition[] = [
  ...
  { zonaId: 'codo', top: '35%', left: '31%', view: 'front' },
  { zonaId: 'codo', top: '35%', left: '69%', view: 'front' },
  { zonaId: 'muneca', top: '49%', left: '29%', view: 'front' },
  { zonaId: 'muneca', top: '49%', left: '71%', view: 'front' },
  { zonaId: 'cadera', top: '44%', left: '42%', view: 'front' },
  { zonaId: 'cadera', top: '44%', left: '58%', view: 'front' },
  { zonaId: 'rodilla', top: '63%', left: '43%', view: 'front' },
  { zonaId: 'rodilla', top: '63%', left: '57%', view: 'front' },
  { zonaId: 'tobillo', top: '83%', left: '44%', view: 'front' },
  { zonaId: 'tobillo', top: '83%', left: '56%', view: 'front' },
  { zonaId: 'pie', top: '93%', left: '44%', view: 'front' },
  { zonaId: 'pie', top: '93%', left: '56%', view: 'front' },
  ...
  { zonaId: 'rodilla', top: '64%', left: '43%', view: 'back' },
  { zonaId: 'rodilla', top: '64%', left: '57%', view: 'back' },
  { zonaId: 'tobillo', top: '82%', left: '44%', view: 'back' },
  { zonaId: 'tobillo', top: '82%', left: '56%', view: 'back' },
];
